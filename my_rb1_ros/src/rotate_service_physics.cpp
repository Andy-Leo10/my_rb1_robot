...
class RB1
{
    ...
    public:
                         ...
                         my_rb1_ros::Rotate::Response &res)
        {
            ...
            float turning_delay=std::abs((req.degrees*M_PI)/(180*angular_velocity));
            if(req.degrees>0)
            {
                rotate_positive();
                delay(turning_delay);
            ...
            quaternion.x = x_orientation;
            quaternion.y = y_orientation;
            quaternion.z = z_orientation;
            quaternion.w = w_orientation;
            // calculate the YAW angle
            int yaw_angle = calculateYawAngle(quaternion);
            // print the angle
            std::cout << "orientation angle (yaw): " << yaw_angle << " degrees" << std::endl;
        ...
        int calculateYawAngle(const geometry_msgs::Quaternion& quaternion)
        {
